...
def get_absolute_path(filenames):
    ...
    relative_path = "../../../../data/nyc_school_attendance/{}".format(filenames)
...
logging.debug("Dataset contains {} rows".format(master_df.count()))
...
logging.debug("Dataset contains {} unique schools".format(unique_schools_df.count()))
...
logging.debug("{} was the year with most students, the district served {} students.".format(year,max))
...
logging.info("Variation on the enrollment from {}:".format(year) )
