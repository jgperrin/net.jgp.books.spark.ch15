...
logging.info("Dataset contains ${df.count} rows, processed in {} ms.".format(t3 - t0))
logging.info("Spark init ... {} ms.".format(t1 - t0))
logging.info("Ingestion .... {} ms.".format(t2 - t1))
logging.info("Output ....... {} ms.".format(t3 - t2))
